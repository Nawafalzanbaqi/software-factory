 ...
 * select, so this feature-local primitive mirrors the shared Input styling (border,
 * focus ring, disabled states) to stay visually consistent. Forwards its ref so
