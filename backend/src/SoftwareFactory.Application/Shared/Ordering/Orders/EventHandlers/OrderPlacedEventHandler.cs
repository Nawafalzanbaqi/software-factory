...
namespace SoftwareFactory.Application.Shared.Ordering.Orders.EventHandlers;

/// <summary>
/// Reacts to <see cref="OrderPlacedDomainEvent"/> after checkout is committed
/// (both verticals). Logs + fires (no-op) notification / e-invoice hooks.
/// </summary>
